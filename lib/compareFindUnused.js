...
module.exports = {
	getSingleSelectors: function(viewcode,selectorsplit){
		...
		var selector =  compareparser.transformSelector(viewcode,selectorsplit[0]);
	...
	getComplexSelectors: function(viewcode,selectorsplit){
		...
		var tag1 = compareparser.transformSelector(viewcode,selector.selector1);
		var tags = compareparser.getTags(viewcode,tag1);
		var tag2 = compareparser.transformSelector(viewcode,selector.selector2);
