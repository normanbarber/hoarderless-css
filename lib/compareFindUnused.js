...
module.exports = {
    findUnusedSelectors: function(viewcode,selectorsplit){
        ...
        selector1 = selector.selector1;
        selector2 = selector.selector2;
        operator = selector.operator;

        var tag = this.getTagAttributes(viewcode,selector1,operator);
        var tagname = tag.tag;
        ...
        if(viewcode){
            ...
            var tag = this.getTagAttributes(viewcode,selector2,operator);
            selectors = tag.selectors;
