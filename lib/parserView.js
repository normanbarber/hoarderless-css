...
module.exports = {
    ...
    start: function(filename,codearray){
        ...
        for(var k in codearray) {
            ...
            var allattributes = tagattributes.get(classarray,idsarray,data_attributes_array);
            ...
            var children_array = tagattributes.getChildren(codearray,k,current_tab_indents);
            var siblings_array = tagattributes.getSiblings(codearray,k,current_tab_indents);
            viewtag.dom[k]= {};
